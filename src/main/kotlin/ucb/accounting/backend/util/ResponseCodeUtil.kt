    ...
    companion object {
        fun getResponseInfo(code: String): ResponseCodeUtil {
            return when (code) {
                ...
                "403-33" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to create an expense transaction.")
                "403-34" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the sale transaction.")
                "403-35" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the expense transaction.")
                "403-36" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the partner.")
                "403-37" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to create a tax associated with subaccount.")
                "403-38" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the taxes.")
