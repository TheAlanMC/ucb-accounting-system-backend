    ...
    companion object {
        fun getResponseInfo(code: String): ResponseCodeUtil {
            return when (code) {
                ...
                "200-41" -> ResponseCodeUtil(HttpStatus.OK, "Transaction information retrieved successfully.")
                "200-42" -> ResponseCodeUtil(HttpStatus.OK, "Journal Entry retrieved successfully.")
                "200-43" -> ResponseCodeUtil(HttpStatus.OK, "Transaction types retrieved successfully.")
                "200-44" -> ResponseCodeUtil(HttpStatus.OK, "Journal Entry has been successfully updated.")
                "200-45" -> ResponseCodeUtil(HttpStatus.OK, "Tax associated with sub accounts has been successfully updated.")
                "200-49" -> ResponseCodeUtil(HttpStatus.OK, "Sales dashboard retrieved successfully.")
                "200-50" -> ResponseCodeUtil(HttpStatus.OK, "Expenses dashboard retrieved successfully.")
                "200-51" -> ResponseCodeUtil(HttpStatus.OK, "Expenses and sales dashboard retrieved successfully.")
                ...
                "403-50" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the expense dashboard.")
                "403-51" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the sales dashboard.")
                "403-52" -> ResponseCodeUtil(HttpStatus.FORBIDDEN, "You don't have the necessary permissions to view the expenses and sales dashboard.")
                ...
                "404-17" -> ResponseCodeUtil(HttpStatus.NOT_FOUND, "Transaction type not found.")
                "404-18" -> ResponseCodeUtil(HttpStatus.NOT_FOUND, "Payment type not found.")
                "404-19" -> ResponseCodeUtil(HttpStatus.NOT_FOUND, "Journal entry not found.")
