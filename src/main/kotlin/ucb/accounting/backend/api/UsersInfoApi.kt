...
import ucb.accounting.backend.dto.UsersInfoDto
...
class UsersInfoApi @Autowired constructor(private val usersInfoBl: UsersInfoBl){
    ...
    fun getUsersInfo(
    ...
    ) : ResponseEntity<ResponseDto<UsersInfoDto>>{
        ...
        return ResponseEntity(ResponseDto(code, responseInfo!!, usersInfo), responseInfo.httpStatus)
    }
}